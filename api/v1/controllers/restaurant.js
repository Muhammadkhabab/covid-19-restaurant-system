...
try {
    ...
    //Calculate current percentage capacity
    const current_percentage = (restaurant.customer_capacity+restaurant.employee_capacity)/(current_customers+current_employees);
    restaurant.current_percent_capacity = current_percentage;
